...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/pdf_flutter/pdf_flutter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/pusher_channels_flutter/pusher_channels_flutter.framework"
