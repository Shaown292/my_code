...
class Data {
  ...
  ProfileTransportPermissions? showPermission;

  Data({this.profileTransport, this.showPermission});

  Data.fromJson(Map<String, dynamic> json) {
    profileTransport = json['profileTransport'] != null ? ProfileTransport.fromJson(json['profileTransport']) : null;
    showPermission = json['show_permission'] != null ? ProfileTransportPermissions.fromJson(json['show_permission']) : null;
  }
...
class ProfileTransportPermissions {
  int? session;
  int? studentClass;
  int? section;
  int? rollNumber;
