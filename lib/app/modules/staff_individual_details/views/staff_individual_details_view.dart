        ...
        customWidget: Column(
          ...
          children: [
            ...
            IndividualDetailsTile(
              address: controller.adminIndividualStaffDetailsResponseModel?.data
                  ?.currentAddress,
              phone: controller
                  .adminIndividualStaffDetailsResponseModel?.data?.mobile,
              title: controller
                  .adminIndividualStaffDetailsResponseModel?.data?.designation,
              qualification: controller.adminIndividualStaffDetailsResponseModel
                  ?.data?.qualification,
              maritalStatus: controller.adminIndividualStaffDetailsResponseModel
                  ?.data?.maritalStatus,
              joiningDate: controller.adminIndividualStaffDetailsResponseModel
                  ?.data?.dateOfJoining,
            ),
          ],
        ),
