...
class TeContentView extends GetView<TeContentController> {
  const TeContentView({super.key});
  @override
        ...
        customWidget: Column(
          children: [
            GridView.builder(
              ...
              itemCount: controller.teacherContent.length,
              ...
              itemBuilder: (context, index) {
                return Obx(
                      () => CustomCardTile(
                    icon: controller.teacherContent[index].icon,
                    title: controller.teacherContent[index].title,
                    iconColor: AppColors.primaryColor,
                    onTap: () {
                      controller.selectIndex.value = index;
                      AppFunctions.getTeacherHomeNavigation(
                        title: controller.teacherContent[index].value,
