...
// import 'package:queen_connect/configure/app_function.dart';
...
//                     GestureDetector(
//                       onTap: (){
//                         singleUserDataFetch(context, userId: privateConversationController.receiverId);
//                       },
//                       child: CircleAvatar(
//                         radius: 22.0,
//                         backgroundImage: privateConversationController.userPhoto != '' && privateConversationController.userPhoto != 'null' ?
//                         NetworkImage('$imageBaseUrl/social_users_files/${privateConversationController.userPhoto}')
...
//                           singleUserDataFetch(context, userId: privateConversationController.receiverId);
//                         },
//                         child: Text('${privateConversationController.userName}', style: const TextStyle(color: AppColors.white, fontSize: 18),)),
//
//                   ],
//                 ),
//               ),
...
//                             children: <Widget>[
//
//                               data['message'] == '' || data['message'] == null ? Container() : Column(
//                                 crossAxisAlignment : CrossAxisAlignment.start,
//                                 children: [
//                                   Padding(
//                                     padding: const EdgeInsets.only(top: 1.2, bottom: 5.8),
//                                     child: Material(
...
//                                     ),
//                                   ),
//                                   Text(AppFunctions().getTimeFromDateAndTime(data['send_time'].toString()), style: TextStyle(color: AppColors.greyColor.shade500, fontSize: 10),),
//                                 ],
//                               ) ,
//
//                               for(var i = 0; i<data['attachments'].length; i++)...{
//                                 Padding(padding: const EdgeInsets.only(bottom: 4, top: 5),
//                                   child: Column(
//                                     crossAxisAlignment : CrossAxisAlignment.start,
//                                     children: [
//                                       Image.network('$imageBaseUrl/social_message_files/${data['attachments'][i]}',  width: w/2, fit: BoxFit.cover,),
...
//                                                       ),
//                                                       child:
//                                                       Center(child: Icon(Icons.add, color: AppColors.textColor, size: h*0.07,),),
//                                                       onPressed:
//                                                           () {
//                                                         pickerCallback();
//                                                       },
